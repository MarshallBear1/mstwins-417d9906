      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h1 style="color: #333; margin-top: 20px;">Reset Your Password</h1>
          </div>
          
          <div style="background: #f8fafc; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
            <h2 style="color: #333; margin-top: 0;">Hi ${firstName || 'there'}! 👋</h2>
            <p style="color: #666; line-height: 1.6;">
              We received a request to reset the password for your MSTwins account. If you made this request, click the button below to set a new password.
            </p>
            <p style="color: #666; line-height: 1.6;">
          ...
          <div style="background: #fef3c7; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
            <h3 style="color: #333; margin-top: 0;">🔒 Security Note</h3>
            <p style="color: #666; line-height: 1.6;">
              This password reset link will expire in 24 hours for your security. If you need another reset link after it expires, you can request a new one from the MSTwins login page.
            </p>
          </div>
