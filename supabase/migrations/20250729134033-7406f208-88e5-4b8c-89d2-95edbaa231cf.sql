...
-- Create security configuration table with proper JSON values
...
-- Insert security configuration settings with proper JSON formatting
INSERT INTO public.security_config (setting_key, setting_value, description) VALUES
    ...
    ('leaked_password_protection', '"enabled"', 'Enable leaked password protection'),
