...
COMMENT ON VIEW public.profile_discovery IS 'Secure view for profile discovery that only exposes safe, non-sensitive profile data for matching purposes. Uses standard permissions, not SECURITY DEFINER.';