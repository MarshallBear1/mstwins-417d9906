...
export default function FeedbackDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[calc(100vw-2rem)] max-w-[500px] p-0 rounded-3xl border-0 shadow-2xl bg-white backdrop-blur-xl overflow-hidden mx-auto fixed top-[40%] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        {/* Modern Header */}
