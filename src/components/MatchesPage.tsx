  ...
  return <div className="h-full flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex space-x-1 bg-gray-100 rounded-lg p-1">
          ...
          return <button key={tab.id} onClick={() => setActiveSubTab(tab.id)} className={cn("flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-sm font-medium transition-all duration-200", isActive ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50")}>
      ...
      <div className="flex-1 overflow-hidden">
        {activeSubTab === 'likes' ? <div className="h-full overflow-y-auto p-4">
