                       ...
                       <SelectContent className="max-h-60 bg-background border shadow-lg z-50">
                         {availablePromptsToShow.map((prompt, index) => (
                           <SelectItem 
                             key={index} 
                             value={prompt}
                             className="cursor-pointer hover:bg-accent min-h-12 p-3 border-b border-border/50 last:border-b-0"
                           >
                             <span className="text-xs leading-snug whitespace-normal text-center block w-full">
                               {prompt}
                             </span>
                           </SelectItem>
                         ))}
