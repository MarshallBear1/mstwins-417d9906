            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-medium">{selectedPost.author.first_name} {selectedPost.author.last_name}</span>
                </div>
                  ...
                  {comments.map(comment => (
                    <div key={comment.id} className="p-3 bg-white border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium text-sm">{comment.author.first_name} {comment.author.last_name}</span>
